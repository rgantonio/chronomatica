...
tasklet = state.add_tasklet(
    ...
    outputs={'c'},
    code='''
        // Read from AXI-Stream inputs, write to AXI-Stream output
        // DaCe ports: s_axis_a_tdata, s_axis_b_tdata, m_axis_c_tdata

        // Accept inputs when both are valid
        ...
        // Output is valid when both inputs are valid
